...
class DataArguments:
    data_dir: str = field(
        default="output/reward_model_data/high_level", metadata={"help": "Path to the training data."}
    )
    eval_part: str = field(
        default=None, metadata={"help": "The part of the data to use for evaluation: part0, part1, part2, part3, part4."}
    )
...
def main():
    ...
    if training_args.deepspeed is not None:
        try:
            if not dist.is_initialized() or training_args.local_rank == 0:
