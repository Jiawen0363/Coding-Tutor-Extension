...
class Preprocessor(object):
    ...
    def preprocess_by_round(self, source) -> Dict:
        ...
        roles = {"student": conv.roles[0], "tutor": conv.roles[1]}
        ...
        if roles[source_convs[0]["from"]] != conv.roles[0]:
            # Skip the first one if it is not from student
