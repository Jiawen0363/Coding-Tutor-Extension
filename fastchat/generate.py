...
def main(
    ...
    padding_side: str = "left",  # allow batched inference
    truncation_side: str = "left",
    cutoff_len: int = 1024,
    template_name: str = "vicuna_v1.1",
    num_proc: int = 8,   # num_proc > 1 will speed up the tokenization
    ...
    def tokenize_prompt(data_point):
        ...
        conversations[-1]["value"] = ""  # remove the last system utterance
    ...
    # otherwise, batched dataset can't be converted to tensors
    ...
    for dataloader_tuple in all_dataloaders:
        ...
        for batch in tqdm(dataloader):
            with torch.no_grad():
                ...
                # Due to the left-side padding, the generated tokens are always at the right-side of the sequence.
