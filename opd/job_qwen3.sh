...
export MODEL_ROOT="${MODEL_ROOT:-/data/models}"
export STUDENT_MODEL="${STUDENT_MODEL:-Qwen3-8B}"
export TEACHER_MODEL_PATH="${TEACHER_MODEL_PATH:-$PROJECT_ROOT/checkpoints/sft-Qwen3-8B/checkpoint-200}"
export OUTPUT_DIR="${OUTPUT_DIR:-$PROJECT_ROOT/checkpoints/OPD/Qwen3-8B-$TIMESTAMP}"
export TRAINER="${TRAINER:-sdft}"
export TEACHER_MODEL_KIND="${TEACHER_MODEL_KIND:-base}"
export MAX_PROMPT_LENGTH="${MAX_PROMPT_LENGTH:-4096}"
export MAX_LENGTH="${MAX_LENGTH:-4352}"
export CHAT_TEMPLATE="${CHAT_TEMPLATE:-$PROJECT_ROOT/scripts/run/qwen3_nonthinking.jinja}"
